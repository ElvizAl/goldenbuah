...
import { adminUpdateAddress } from "@/modules/address/service/admin-address.service";
...
type AdminEditAddressBtnProps = {
  address: any;
};

export function AdminEditAddressBtn({ address }: AdminEditAddressBtnProps) {
  ...
  async function onSubmit(values: AddressInput) {
    ...
    const result = await adminUpdateAddress(address.id, formData);
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="max-h-[90vh] overflow-y-auto sm:max-w-2xl">
        <DialogHeader>
          <DialogTitle>Admin Edit Alamat</DialogTitle>
          <DialogDescription>
            Ubah data alamat pengiriman pelanggan dari dashboard administrasi.
          </DialogDescription>
        </DialogHeader>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
          ...
          <div className="rounded-xl border border-dashed border-neutral-200 p-4">
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
              <div className="space-y-1.5">
                ...
                >
                  <option value="">
                    {isLoadingProvince ? "Memuat..." : "Pilih provinsi"}
                  </option>
              ...
              <div className="space-y-1.5">
                ...
                >
                  <option value="">
                    {isLoadingCity ? "Memuat..." : "Pilih kota"}
                  </option>
                  {cities.map((city) => (
              ...
              <div className="space-y-1.5">
                ...
                >
                  <option value="">
                    {isLoadingDistrict ? "Memuat..." : "Pilih kecamatan"}
                  </option>
              ...
              <div className="space-y-1.5">
                ...
                >
                  <option value="">
                    {isLoadingSubdistrict ? "Memuat..." : "Pilih kelurahan"}
                  </option>
          ...
          <label className="flex items-center gap-2 text-sm font-medium text-neutral-700">
            <input
              ...
              {...register("isDefault")}
            />
            Jadikan alamat utama pengguna tersebut
          </label>
