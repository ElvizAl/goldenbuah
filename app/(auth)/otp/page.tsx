      ...
      <div className="relative hidden overflow-hidden bg-muted lg:block">
        ...
        <div className="absolute inset-x-0 bottom-0 p-10 text-white">
          ...
          <h2 className="max-w-md text-3xl font-bold leading-tight">
            Masukkan kode OTP untuk mengaktifkan akun Anda.
          </h2>
          <p className="mt-3 max-w-md text-sm text-white/85">
            Satu langkah lagi untuk mulai belanja buah segar dan dapatkan penawaran eksklusif member.
          </p>
        </div>
      </div>
        ...
        <div className="flex flex-1 items-center justify-center">
          <div className="w-full max-w-sm">
            ...
            <p className="mt-6 text-center text-xs text-muted-foreground">
              Kode OTP dikirim ke email terdaftar Anda, cek folder spam jika belum masuk.
            </p>
          </div>
        </div>
      </div>
