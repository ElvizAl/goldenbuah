  ...
  return (
    <div className="grid min-h-svh lg:grid-cols-2">
      <div className="relative hidden overflow-hidden bg-muted lg:block">
        <img
          src="https://images.unsplash.com/photo-1579113800032-c38bd7635818?q=80&w=2070&auto=format&fit=crop"
          alt="Aneka buah potong segar"
        ...
        <div className="absolute inset-x-0 bottom-0 p-10 text-white">
          ...
          <h2 className="max-w-md text-3xl font-bold leading-tight">
            Buat akun dan dapatkan akses promo buah terbaik.
          </h2>
          <p className="mt-3 max-w-md text-sm text-white/85">
            Daftar hanya beberapa langkah untuk checkout lebih cepat dan rekomendasi produk sesuai selera Anda.
          </p>
        </div>
      </div>
        ...
        <div className="flex flex-1 items-center justify-center">
          <div className="w-full max-w-sm">
            ...
            <p className="mt-6 text-center text-xs text-muted-foreground">
              Gratis biaya pendaftaran, langsung bisa mulai belanja sehat.
            </p>
          </div>
        </div>
      </div>
