  ...
  return (
    <div className="grid min-h-svh lg:grid-cols-2">
      <div className="relative hidden overflow-hidden bg-muted lg:block">
        <img
          src="https://images.unsplash.com/photo-1610348725531-843dff563e2c?q=80&w=2069&auto=format&fit=crop"
        ...
        <div className="absolute inset-x-0 bottom-0 p-10 text-white">
          <p className="mb-2 text-sm font-semibold uppercase tracking-[0.2em] text-emerald-200">
            Golden Fruit Market
          </p>
          <h2 className="max-w-md text-3xl font-bold leading-tight">
            Masuk dan nikmati buah segar pilihan setiap hari.
          </h2>
          <p className="mt-3 max-w-md text-sm text-white/85">
            Belanja lebih cepat, pantau promo terbaru, dan atur pesanan favorit Anda dalam satu akun.
          </p>
        </div>
      </div>
        ...
        <div className="flex flex-1 items-center justify-center">
          <div className="w-full max-w-sm">
            ...
            <p className="mt-6 text-center text-xs text-muted-foreground">
              Mulai pagi sehat Anda dengan buah premium, siap antar ke rumah.
            </p>
          </div>
        </div>
      </div>
