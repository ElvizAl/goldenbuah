  ...
  return (
    <div className="grid min-h-svh lg:grid-cols-2">
      <div className="relative hidden overflow-hidden bg-muted lg:block">
        <img
          src="https://images.unsplash.com/photo-1601004890684-d8cbf643f5f2?q=80&w=2070&auto=format&fit=crop"
          alt="Buah segar untuk gaya hidup sehat"
          className="absolute inset-0 h-full w-full object-cover"
        />
        <div className="absolute inset-0 bg-linear-to-t from-black/70 via-black/35 to-transparent" />
        <div className="absolute inset-x-0 bottom-0 p-10 text-white">
          <p className="mb-2 text-sm font-semibold uppercase tracking-[0.2em] text-lime-200">
            Reset Akses Akun
          </p>
          <h2 className="max-w-md text-3xl font-bold leading-tight">
            Lupa kata sandi? Tenang, atur ulang dengan cepat.
          </h2>
          <p className="mt-3 max-w-md text-sm text-white/85">
            Kami kirimkan instruksi pemulihan agar Anda bisa kembali belanja buah favorit tanpa ribet.
          </p>
        </div>
      </div>
      <div className="flex flex-col gap-4 p-6 md:p-10">
        <div className="flex justify-center gap-2 md:justify-start">
          <Link href="/" className="flex items-center gap-2 font-medium">
            ...
            <span className="text-xl font-bold">Golden Fruit</span>
          </Link>
        </div>
        <div className="flex flex-1 items-center justify-center">
          <div className="w-full max-w-sm">
            ...
            <p className="mt-6 text-center text-xs text-muted-foreground">
              Pastikan email aktif agar proses pemulihan akun berjalan lancar.
            </p>
          </div>
        </div>
      </div>
