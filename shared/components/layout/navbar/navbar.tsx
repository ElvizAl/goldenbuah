      ...
      <div className="max-w-7xl mx-auto px-4 border-b">
        <div className="flex h-16 justify-between items-center">
          ...
          <Link href="/" className="flex items-center space-x-2 shrink-0">
            ...
            <span className="text-xl font-bold hidden sm:block">Golden Fruit</span>
          </Link>
          ...
          {/* Right side: cart + user + mobile burger */}
          <div className="flex items-center gap-2">
            <Suspense fallback={<ShoppingBag className="h-6 w-6 text-neutral-700" />}>
              <CartBadge />
            </Suspense>
